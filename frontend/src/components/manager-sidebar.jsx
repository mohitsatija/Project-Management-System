...
export function ManagerSidebar({ ...props }) {
  ...
  const handleLogout = () => {
    ...
    },
    {
      title: "My Projects", 
      icon: IconFolder,
      onClick: () => handleNavigation("/manager/my-projects")
    },
    {
      title: "Manage Tasks", 
      icon: IconChecklist,
      onClick: () => handleNavigation("/manager/tasks")
    },    {
      title: "Create Task",
      icon: IconPlus,
      onClick: () => handleNavigation("/manager/tasks/create")
    },
    {
      title: "Team Members",
      icon: IconUsers,
      onClick: () => handleNavigation("/manager/team-members")
    },
    {
      title: "Logout",
      icon: IconLogout,
  ...
  return (
    <Sidebar {...props}>      <SidebarHeader className="pb-4">
        <SidebarMenu>
          <SidebarMenuItem>
      ...
      </SidebarHeader><SidebarContent className="pt-6">
